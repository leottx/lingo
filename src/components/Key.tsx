...
export const Key = ({ keyValue, color, handleKeyClick }: KeyProps) => {
  ...
  return (
    <button
      className={cn(
        'col-span-3 text-neutral-100 font-bold text-sm duration-300 transition-colors bg-neutral-500 h-12 flex justify-center items-center px-[10px] rounded-[4px] uppercase sm:text-lg md:text-2xl sm:h-16',
        {
